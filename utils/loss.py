...
# Existing depth loss function
def depth_loss_function(y_true, y_pred, maxDepthVal=1000.0/10.0):
...
def combined_loss(y_true, y_pred, maxDepthVal=1000.0/10.0, alpha=1.0, beta=1.0, gamma=1.0, delta=1.0):
    # Original depth loss
    depth_loss = depth_loss_function(y_true, y_pred, maxDepthVal)
